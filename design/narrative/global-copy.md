...
- ⑩ 有效照料与奖励：普通难度（轻松/标准/困难/大师）推进信任、疗愈、宗门阅历和主线故事；挑战模式固定 5 点灵力，只按表现发素材。每次有效照料都能获得普通素材，不设每日场数上限。
...
- ⑬ 神兽成长：信任、疗愈、宗门阅历都达标后，它会自动长成下一形态，并讲一段小故事。山海册可看 12 兽 60 形态，也能换回喜欢的旧样子。
...
- needs：普通小游戏消耗 1–4 点灵力，挑战模式固定 5 点。普通模式加信任和疗愈，挑战模式只按表现发素材。
