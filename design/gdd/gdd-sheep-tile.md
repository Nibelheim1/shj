...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 轻松 | 4×4 | 1 | 4 | 4 | 70s | 0.58 | 教学局，按通关/分数结算 |
| 标准 | 5×5 | 2 | 6 | 12 | 80s | 0.72 | 分数也可推进奖励 |
| 困难 | 6×6 | 3 | 8 | 16 | 90s | 0.84 | **未通关也按得分匹配 B/A 档奖励** |
| 大师 | 7×7 | 4 | 10 | 20 | 100s | 0.84 | 高分失败可拿 A 档奖励 |
| 挑战 | 8×8 | 5 | 10 | 20 | 150s | 0.84 | 独立入口：体力 5，只按分数发素材 |
