...
check('配置含四档难度、原版式玩具塔和统一奖励表', function () {
  ...
  assert.strictEqual(DATA.careGames.difficulties.easy.play.totalTiles, 21);
  assert.strictEqual(DATA.careGames.difficulties.easy.play.slots, 5);
  assert.strictEqual(DATA.careGames.difficulties.easy.play.timeLimit, 90);
  assert.strictEqual(DATA.careGames.difficulties.easy.play.storyRound, true);
  assert.strictEqual(DATA.careGames.difficulties.normal.play.layers, 4);
  ...
  assert.strictEqual(DATA.careGames.difficulties.hard.play.rows, 5);
  assert.strictEqual(DATA.careGames.difficulties.master.play.cols, 5);
  assert.strictEqual(DATA.careGames.difficulties.master.play.rows, 5);
  assert.strictEqual(DATA.careGames.difficulties.hard.play.tilesPerType, 6);
  assert.strictEqual(DATA.careGames.difficulties.hard.play.reserveStacks, 4);
  assert.strictEqual(DATA.careGames.difficulties.master.play.typeCount, 12);
  assert.strictEqual(DATA.careGames.difficulties.hard.play.scoreTarget, 5400);
  assert.strictEqual(DATA.careGames.difficulties.master.play.failPerfCap, 0.76);
  assert.strictEqual(DATA.careGames.effectiveActions.play, 3);
  assert.strictEqual(DATA.careGames.difficulties.master.play.comboWindow, 1.2);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.cols, 6);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.rows, 5);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.layers, 5);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.tilesPerType, 6);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.slots, 5);
  assert.strictEqual(DATA.careGames.difficulties.challenge.play.reserveStacks, 4);
