...
(function (root) {
  ...
  var pages = [
    ...
    ['15', 'bag', '行囊药匣页', 'page', 'bag-view', 'backgrounds/fullscreen/bg_floral_blue_clean.webp'],
    ['16', 'recipe', '配方调配页', 'page', 'bag-view', 'backgrounds/fullscreen/bg_floral_blue_clean.webp'],
